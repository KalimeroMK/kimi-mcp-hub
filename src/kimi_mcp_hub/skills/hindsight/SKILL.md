...
name: hindsight
description: >
  Memory that learns from mistakes. Activate when user says "remember this",
  "don't forget", "we tried this before", "last time we", or when
  encountering recurring errors, patterns, or decisions.
---
