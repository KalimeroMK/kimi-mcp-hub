...
description: Safe database migration patterns across PostgreSQL, MySQL, and common ORMs.
type: prompt
whenToUse: When creating or altering database schemas, data migrations, rollbacks, or zero-downtime deployments.
