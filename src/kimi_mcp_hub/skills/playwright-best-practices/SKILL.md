...
description: Playwright E2E, component, API, accessibility, and visual testing best practices.
type: prompt
whenToUse: When writing, debugging, or maintaining Playwright tests, Page Object Model, CI/CD, mocking, or flaky test issues.
