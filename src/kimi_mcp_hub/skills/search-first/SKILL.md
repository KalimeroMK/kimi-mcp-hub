---
name: search-first
description: Research-before-coding workflow: find existing tools and patterns first.
type: prompt
whenToUse: When starting a new feature or integration and searching for existing libraries, tools, or patterns before writing custom code.
