...
name: ts-coder
description: >
  TypeScript specialist. Activate for TypeScript code, types, generics,
  or when user says "TypeScript", "TS", "type", "generic", "interface",
  "type inference", "strict mode", "tsconfig", "type-safe".
---
