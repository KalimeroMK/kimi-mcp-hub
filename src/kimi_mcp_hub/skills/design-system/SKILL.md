---
name: design-system
description: Design tokens, component specifications, and systematic design systems.
type: prompt
whenToUse: When defining design tokens, component specs, spacing/typography scales, CSS variables, or building a design system.
