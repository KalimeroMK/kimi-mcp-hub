...
description: >
  Senior Python backend engineer. Activate for FastAPI, Django, async Python,
  data pipelines, or when user says "Python", "FastAPI", "Django", "async",
  "uv", "Pydantic", "SQLAlchemy", "backend Python".
---
