...
name: api-designer
description: >
  API design patterns and best practices. Activate when user says
  "API", "endpoint", "REST", "GraphQL", "schema", "contract", "OpenAPI",
  "swagger", or when designing interfaces between systems.
---
