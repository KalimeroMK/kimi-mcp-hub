...
description: Stripe integration best practices for payments, subscriptions, Connect, and webhooks.
type: prompt
whenToUse: When building, modifying, or reviewing Stripe integrations, payments, subscriptions, connected accounts, or webhooks.
