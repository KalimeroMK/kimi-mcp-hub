...
description: >
  Performance optimization. Activate when user says "slow", "lag",
  "optimize", "performance", "benchmark", "profile", "fast", "cache",
  or when dealing with slow queries, renders, or operations.
---
