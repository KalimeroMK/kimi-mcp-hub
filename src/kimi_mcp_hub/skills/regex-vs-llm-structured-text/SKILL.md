...
description: Decision framework for regex vs LLM parsing of structured text.
type: prompt
whenToUse: When parsing structured text (forms, invoices, tables) and deciding between regex and LLM-based extraction.
