...
description: WordPress plugin development with hooks, Settings API, security, and release packaging.
type: prompt
whenToUse: When developing or refactoring WordPress plugins, admin UI, settings, hooks, activation lifecycle, or plugin security.
