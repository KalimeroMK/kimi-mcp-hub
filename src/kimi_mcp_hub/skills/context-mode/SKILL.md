...
name: context-mode
description: >
  Context window optimization. Activate when approaching token limits,
  or user says "context limit", "token budget", "out of context",
  "compress context", or for very large codebases.
---
